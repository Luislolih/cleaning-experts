    ...
    <main className={styles.mainContainer}>
      ...
      >
        <div className={styles.responsiveEngCont}>
          <div className={styles.totalLanguage}>
            ...
            >
              {language === "en" ? (
                <>
                  <LiaLanguageSolid className={styles.iconFlag} />{" "}
                  <p className={styles.textChangeLanguage}>English</p>
                  <BiChevronDown className={styles.iconBiChevronDown} />
                </>
              ) : (
                <>
                  <LiaLanguageSolid className={styles.iconFlag} />
                  <p className={styles.textChangeLanguage}>Español</p>{" "}
                  <BiChevronDown className={styles.iconBiChevronDown} />
                </>
              )}
            </button>
        ...
        <div className={styles.itemsRight}>
           ...
           */}
            <div className={styles.servicesDrop}>
              <div className={styles.servicesArrow}>
                <strong>
                  <Link to="/services" className={styles.buttonNav}>
              ...
              >
                {serviceOptions.map((service, index) => (
                  <Link to={`/services/${service.slug}`}>
                    <li key={index} className={styles.serviceOptions}>
                      {service.title}
                      {/* Todo: service/:id */}
                    </li>
                  </Link>
          ...
          <strong>
            <Link to="/about" className={styles.buttonNav}>
              {language === "en" ? "ABOUT US" : "NOSOTROS"}
            </Link>
          </strong>
          <strong>
            <Link to="/experience" className={styles.buttonNav}>
